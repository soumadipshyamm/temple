<div class="modal fade" id="addNews" tabindex="-1" role="dialog" aria-labelledby="addNewsTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body add-modal">
                <form method="POST" action="{{ route('news.add') }}" data-url="{{ route('news.add') }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 my-2">
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control" id="news_url"
                                    name="news_url"   placeholder="Enter your news URL">
                            </div>
                        </div>
                        <div class="col-md-12 my-2">
                            <div class="form-group">
