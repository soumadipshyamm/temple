<div class="modal fade" id="addAlliedServices" tabindex="-1" role="dialog" aria-labelledby="addAlliedServicesTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Add Allied Services</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body add-modal">
                <form method="POST" action="{{ route('alliedServices.add') }}" data-url="{{ route('alliedServices.add') }}"
                        ...
                        <div class="col-md-12 my-2">
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control" id="url"
                                    name="url" placeholder="Enter your allied services URL">
