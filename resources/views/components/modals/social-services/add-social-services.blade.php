<div class="modal fade" id="addSocialServices" tabindex="-1" role="dialog" aria-labelledby="addSocialServicesTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Add Social Services</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body add-modal">
                <form method="POST" action="{{ route('socialServices.add') }}"
                    data-url="{{ route('socialServices.add') }}" class="formSubmit fileUpload"
